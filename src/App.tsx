...
const App = () => {
    ...
    const calculateCoordinates = async () =>{
        if(radius!=='0'&& height !=='0' && segments !=='0'){
            const response = await axios.post('http://localhost:5000/calculatecoordinates', {radius,height,segments})
    ...
    return (
        <div className="bg-black">
            <div className=" absolute h-screen overflow-scroll top-0 left-0 flex flex-col items-center text-white bg-black w-2/5">
                ...
                <div className="flex justify-center mt-5">
                    ...
                    <Input value={segments} setValue={setSegments} label="Cone Segments" fetchData={calculateCoordinates}/>
                </div>
            ...
            <div style={{backgroundColor:'black', width:'60%', height:'100%',position:'absolute',right:0,}}  id="scene-container">
            </div>
        </div>
    );
};
